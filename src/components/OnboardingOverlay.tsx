...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    body:     'SINGLE PLAYER works through worlds — Town Star, Mirandus, Galaswap and more — with words themed to each. The DAILY challenge is one tough 8-minute round per day. Win it to build a streak; lose it and pay 1 GALA to retry.',
    accent:   '#fbbf24',
  ...
  },
  {
    ...
    body:     'Spend GALA to unlock PREMIUM worlds — Area 51, Asimov Robotics, Peaks & Trails. Or pay into the WEEKLY EVENT for a leaderboard run: top 3 at the end of the week claim hint-pack rewards. Connect a wallet to sync progress across devices.',
    accent:   '#22d3ee',
