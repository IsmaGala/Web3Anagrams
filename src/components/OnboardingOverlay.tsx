...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    body:     'SINGLE PLAYER works through worlds — Town Star, Mirandus, Galaswap and more — with words themed to each. The DAILY challenge is one tough 8-minute round per day. Win it to build a streak; lose it and pay 1 GEM to retry.',
    accent:   '#fbbf24',
